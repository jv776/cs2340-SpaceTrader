...
public abstract class CrewMember {
    ...
    public CrewMember(int pilotSP, int fighterSP, int traderSP, int engineerSP, int investorSP) {
        this.pilotSkillPoints = pilotSP;
        this.fighterSkillPoints = fighterSP;
        this.traderSkillPoints = traderSP;
        this.engineerSkillPoints = engineerSP;
        this.investorSkillPoints = investorSP;
    }
