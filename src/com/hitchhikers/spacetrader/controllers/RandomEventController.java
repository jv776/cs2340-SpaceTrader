...
import com.hitchhikers.spacetrader.models.Encounterable;
...
public abstract class RandomEventController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        playerPic.setImage(new Image(Utils.getResourceAsStream("images/current.png")));
        otherPic.setImage(new Image(Utils.getResourceAsStream("images/unreachable.png")));
